...
abstract class TencentCloudChatComponentBuilder {
  ...
  getContactAddContactsInfoRemarksAndGroupBuilder(Function(String value) getRemarks,
  ...
  getContactApplicationItemButtonBuilder(V2TimFriendApplication application, ContactApplicationResult applicationResult,
      void Function(ContactApplicationResult result) getApplicationResultFromButton) {}
  ...
  getContactApplicationInfoButtonBuilder(V2TimFriendApplication application, Function? resultFunction,
  ...
  getGroupProfileAvatarBuilder(
      {required V2TimGroupInfo groupInfo, required List<V2TimGroupMemberFullInfo> groupMember}) {}

  getGroupProfileContentBuilder({required V2TimGroupInfo groupInfo}) {}

  getGroupProfileChatButtonBuilder(
      {required V2TimGroupInfo groupInfo, VoidCallback? startVideoCall, VoidCallback? startVoiceCall}) {}
  ...
  getGroupProfileMemberBuilder(
      {required V2TimGroupInfo groupInfo, required List<V2TimGroupMemberFullInfo> groupMember, required List<
          V2TimFriendInfo> contactList}) {}
  ...
  getGroupAddMemberPageBuilder({required List<V2TimGroupMemberFullInfo> memberList, required List<
      V2TimFriendInfo> contactList, required V2TimGroupInfo groupInfo}) {}
