...
class TencentCloudChatUtils {
    ...
    if (message != null) {
      ...
      switch (message.elemType) {
        ...
        case MessageElemType.V2TIM_ELEM_TYPE_GROUP_TIPS:
          text = buildGroupTipsText(message.groupTipsElem);
          break;
  ...
  static String buildGroupTipsText(V2TimGroupTipsElem? tips) {
    ...
    if (tips != null) {
      ...
      String membersDisplayText = memberList
          ...
          .join(",");
      membersDisplayText = "\"$membersDisplayText\"";
      ...
      opMemberDisplayText = "\"$opMemberDisplayText\"";
      ...
      switch (type) {
        ...
        case GroupTipsElemType.V2TIM_GROUP_TIPS_TYPE_QUIT:
          res = tL10n.memberLeftGroup(opMemberDisplayText);
          break;
        ...
        case GroupTipsElemType.V2TIM_GROUP_TIPS_TYPE_SET_ADMIN:
          res = tL10n.setToAdmin(membersDisplayText);
          break;
        case GroupTipsElemType.V2TIM_GROUP_TIPS_TYPE_CANCEL_ADMIN:
          res = tL10n.revokedAdmin(membersDisplayText);
          break;
  ...
  static (String, String?) handleCustomMessage(V2TimMessage message) {
    ...
    if (isCreateGroupCustomMessage(message)) {
      lineOne = getCreateGroupCustomText(message);
    }
  ...
  static String getShowName(V2TimMessage message) {
    if (message.nameCard != null && message.nameCard!.isNotEmpty) {
      return message.nameCard!;
    } else if (message.friendRemark != null && message.friendRemark!.isNotEmpty) {
      return message.friendRemark!;
